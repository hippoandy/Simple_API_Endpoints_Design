...
This is a simple API endpoints application which depict a customer shopping order management system. I treated this project as a practices for designing and implementing a small working system. The server provides API endpoints to get information from the database in the format of ***JSON***, **XML**, and ***CSV***.
